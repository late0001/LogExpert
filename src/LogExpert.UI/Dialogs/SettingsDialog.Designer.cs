...
partial class SettingsDialog
{
    ...
    private void InitializeComponent ()
    {
        ...
        labelControlCharsWarning.Text = "Display only ¡ª does not modify file contents or affect search, filter, or copy-to-clipboard (unless the option below is enabled). Enabling this can make some log files look unusual.";
        // 
